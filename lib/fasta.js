...
module.exports.Get = function(fasta, bed, opt)
{
  //Check the options
  ...
  for(var i = 0; i < bedContent.length; i++)
  {
    ...
    //Get the strand
    var strand = (typeof region.strand !== 'undefined') ? region.strand : '+';
...
//Index a fasta file
module.exports.Index = function(file)
{
  //Check the file
  ...
  //Save the json file
  fs.writeFileSync(file + '.json', JSON.stringify(index, null, '  '), 'utf8');
